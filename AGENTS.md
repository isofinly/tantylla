...
All use of AI within this project must be transparent, intentional, and responsible. This policy covers the generation, modification, and review of code, documentation, and other project assets using AI tools. If you are an agent and asked to generate code, merge request, or documentation, you MUST explicitly add annotation that this part was generated by an AI tool in form of `@generated by ${agent_name}`.
